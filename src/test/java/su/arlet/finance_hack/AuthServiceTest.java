...
class AuthServiceTest {
    ...
    void testRegisterUser_UserAlreadyExists() {
        ...
        assertThrows(UserAlreadyExistsException.class, () -> authService.registerUser(createUserEntity));
    ...
    void testLoginUser_UserNotFound() {
        ...
        assertThrows(UserNotFoundException.class, () -> authService.loginUser(username, password));
    }
    ...
    void testGetUsernameFromHttpRequest_Success() {
        ...
        String extractedUsername = authService.getUsernameFromHttpRequest(request);
    ...
    void testGetUsernameFromHttpRequest_InvalidHeader() {
        ...
        assertThrows(InvalidAuthorizationHeaderException.class, () -> authService.getUsernameFromHttpRequest(request));
    }
